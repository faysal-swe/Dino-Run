...
class Enemy extends Character {
  ...
  static final Map<EnemyType, EnemyData> _enemyDetails = {
    EnemyType.angryPig: EnemyData(imageName: 'Walk (36x30).png', srcSize: Vector2(36, 30), to: 15),
    EnemyType.bat: EnemyData(imageName: 'Flying (46x30).png', srcSize: Vector2(46, 30), to:6),
    EnemyType.rino: EnemyData(imageName: 'Run (52x34).png', srcSize: Vector2(52, 34), to: 5),
  };
  ...
  void resize(Vector2 size, double groundHeight, int numberOfTilesAlongWidth) {
    characterHeight = size.x / numberOfTilesAlongWidth;
